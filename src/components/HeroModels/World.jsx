...
Command: npx gltfjsx@6.5.3 a_windy_day.glb 
...
export function World(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/assets/models/a_windy_day.glb')
...
useGLTF.preload('/assets/models/a_windy_day.glb')
